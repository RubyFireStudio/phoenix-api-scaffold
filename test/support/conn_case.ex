defmodule ReanixWeb.ConnCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import ReanixWeb.Router.Helpers
      import Reanix.Factory

      # The default endpoint for testing
      @endpoint ReanixWeb.Endpoint
    end
  end

  setup tags do
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(Reanix.Repo)

    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(Reanix.Repo, {:shared, self()})
    end
